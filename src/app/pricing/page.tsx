        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mx-auto mt-28 max-w-3xl">
            <motion.h2
              ...
              className="text-center text-[28px] font-black text-[#0a0e27] sm:text-[36px]"
            >
            ...
            <div className="mt-12 space-y-3">
              {faqs.map((faq, i) => (
                <motion.div
                  ...
                  className="overflow-hidden rounded-2xl border border-[#e2e8f0] transition-colors duration-300 hover:border-[#cbd5e1]"
                >
                  <button
                    type="button"
